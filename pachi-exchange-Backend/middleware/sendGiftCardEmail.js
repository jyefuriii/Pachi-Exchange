...
const sendGiftCardEmail = async (
  ...
  try {
    ...
    const output = await transporter.sendMail({
      ...
      <div align="center" style="line-height:10px"><img alt="Check Icon" src="https://i.pinimg.com/originals/7d/b3/24/7db324ed27acf79d21e3a3132287623c.gif" style="display: block; height: 40%; border: 0;border-radius: 70%; width: 40%; max-width: 100%;" title="Check Icon" width="93"/></div>
      <p style="margin: 0; text-align: center; letter-spacing: 1px;"><strong><span style="font-size:32px;color:#3fa2f7;">Gift Card Purchase</span></strong></p>
      </div>
      </div>
      </td>
      </tr>
      ...
      <p style="margin: 0; font-size: 16px; text-align: right;"><strong><span style="font-size:16px;"><span style="color:#5d77a9;">Gift Card:</span></span></strong></p>
      <p style="margin: 0; font-size: 16px; text-align: right;"><strong><span style="font-size:16px;"><span style="color:#5d77a9;">Price:</span></span></strong></p>
      <p style="margin: 0; font-size: 16px; text-align: right;"><strong><span style="font-size:16px;"><span style="color:#5d77a9;">Purchase Date:</span></span></strong></p>
      </div>
      </div>
      </td>
      </tr>
      ...
      <p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;"><span style="font-size:16px;">${name}</span></p>
      <p style="margin: 0; font-size: 16px; text-align: left;">$${price}</p>
