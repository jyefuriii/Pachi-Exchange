    ...
    <div className="sweepstakesPage">
      ...
      <div className="sweepstakesBackground_content">
        <img
          ...
          src="./sweepstakes_bg.png"
          alt=""
        />
        <img
          className="sweepstakesMobileBackground"
          src="./sweepstakesMobile_bg.png"
          alt=""
        />
      </div>
      <div className="sweepstakes_container">
        ...
        <div className="sweepstakes_content">
          <div className="sweepstakes_col1">
            <div>
              <img src="./sweepstakes_step1.png" className="steps_img" alt="" />
              <img
                src="./sweepstakes_step1_img.png"
                className="step1_img"
                alt=""
              />
            </div>
          </div>
          <img src="./shop_arrow.png" className="sweepstakes_arrow" alt="" />
          <div className="sweepstakes_col2">
            <div>
              <img src="./sweepstakes_step2.png" className="steps_img" alt="" />
            </div>
          </div>
          <img src="./shop_arrow.png" className="sweepstakes_arrow2" alt="" />
          <div className="sweepstakes_col3">
            <div>
              <img src="./sweepstakes_step3.png" className="steps_img" alt="" />
            </div>
          </div>
        </div>
      </div>
      <div className="sweepstakesPrize_container">
        ...
        <div className="draws_container">
          <div>
            <img src="./daily_draw.png" className="draw_img" alt="" />
          ...
          <div>
            <img src="./weekly_draw.png" className="draw_img" alt="" />
            <div className="draw_fields">
          ...
          <div>
            <img src="./monthly_draw.png" className="draw_img" alt="" />
            <div className="draw_fields">
