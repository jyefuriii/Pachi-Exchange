...
const sendCashoutEmail = async (
  ...
  try {
    ...
    const output = await transporter.sendMail({
      ...
      <div align="center" style="line-height:10px"><img alt="Check Icon" src="https://cdn.dribbble.com/users/2393122/screenshots/4867246/media/504328041c5368426b16031b281a8677.gif" style="display: block; height: 200px; border: 0;border-radius: 50%; width: 200px; max-width: 100%;" title="Check Icon" width="93"/></div>
      <p style="margin: 0; text-align: center; padding-top:30px;letter-spacing: 1px;"><strong><span style="font-size:32px;color:#3fa2f7;">Cashout Request</span></strong></p>
      </div>
      </div>
      </td>
      </tr>
      ...
      <p style="margin: 0; font-size: 16px; text-align: right;"><strong><span style="font-size:16px;"><span style="color:#5d77a9;">Cashout Amount:</span></span></strong></p>
      <p style="margin: 0; font-size: 16px; text-align: right;"><strong><span style="font-size:16px;"><span style="color:#5d77a9;">Remaining Balance:</span></span></strong></p>
      <p style="margin: 0; font-size: 16px; text-align: right;"><strong><span style="font-size:16px;"><span style="color:#5d77a9;">Payment Option:</span></span></strong></p>
      <p style="margin: 0; font-size: 16px; text-align: right;"><strong><span style="font-size:16px;"><span style="color:#5d77a9;">Cashout Date:</span></span></strong></p>
      </div>
      </div>
      </td>
      </tr>
      ...
      <p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 32px;"><span style="font-size:16px;">$${cashoutValue}</span></p>
      <p style="margin: 0; font-size: 16px; text-align: left;">$${updatedCashAmount}</p>
      <p style="margin: 0; font-size: 16px; text-align: left;">${cashoutOption}</p>
      <p style="margin: 0; font-size: 16px; text-align: left;">${purchaseDate}</p>
      </div>
      </div>
      </td>
      </tr>
...
export default sendCashoutEmail;
